...
import img1 from "../assets/img/project.png";
import img2 from "../assets/img/project2.png";
import img3 from "../assets/img/project.png";
import img4 from "../assets/img/project.png";
import img5 from "../assets/img/project.png";
import img6 from "../assets/img/project2.png";

const Porfolio = () => {
  return (
    <div className=" min-h-screen flex flex-col justify-center items-center lag:px-32 px-5 bg-backgroundColor">
